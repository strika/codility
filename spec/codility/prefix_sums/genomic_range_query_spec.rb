  ...
  module PrefixSums
    RSpec.describe GenomicRangeQuery do
      ...
      it "calculates impact factors" do
        ...
        expect(GenomicRangeQuery.solution(s, p, q)).to eql([2, 4, 1])
      end
      ...
      context "with short sequence" do
        it "calculates impact factors" do
          ...
          expect(GenomicRangeQuery.solution(s, p, q)).to eql([1])
        end
      end
      ...
      context "another short sequence" do
        it "calculates impact factor" do
          ...
          expect(GenomicRangeQuery.solution(s, p, q)).to eql(GenomicRangeQuery.solution_slow(s, p, q))
        end
      end
      ...
      context "with larga data set" do
        it "calculates impact factors" do
          ...
          time = Benchmark.realtime do
            expect(GenomicRangeQuery.solution(s, p, q)).to be_an_instance_of(Array)
          end
